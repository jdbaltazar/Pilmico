...
public class MenuPanel extends JPanel implements ActionListener {
	...
	private String[] btn = { "product.png", "sales.png", "expenses.png",
			"accountreceivable.png", "delivery.png", "cashadvance.png",
			"superform.png", "person.png", "extras.png", "log.png" };
	
	private String[] btn2 = { "product2.png", "sales2.png", "expenses2.png",
			"accountreceivable2.png", "delivery2.png", "cashadvance2.png",
