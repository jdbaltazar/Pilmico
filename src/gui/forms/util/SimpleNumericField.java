...
public class SimpleNumericField extends JTextField{
    ...
    public SimpleNumericField(int iMaxLen) {
        this(iMaxLen, DECIMAL);
    }

    public SimpleNumericField(int iMaxLen, int iFormat) {
