...
public class InventorySheetForm extends SimplePanel {
	...
	private SubTableHeaderLabel begInvtyLabel, onDisplayLabel, delLabel,
			...
			liabilitiesLabel, pcohLabel, cohLabel, summary1Label, summary2Label, summary3Label, accLabel;
	...
	private void init() {
		...
		salesPane = new JScrollPane(salesPanel);
	...
	private void addComponents() {
		...
		productsPane.setBounds(startX + 1, productLabel.getHeight()
				+ productLabel.getY() - 1,
				salesLabel.getX() + salesLabel.getWidth() - productLabel.getX() + SCROLLBAR_WIDTH
						- 1, 350);
		...
		for(int i = 0, x = 0; i < TOTAL_INVENTORY_LABEL - 4; i++, x+=sack1Label.getWidth())
				totalInventoryLabel.get(i).setBounds(productTotalLabel.getX() + productTotalLabel.getWidth() + x - 1,
		...
		for(int i = TOTAL_INVENTORY_LABEL - 4, x = 0; i < TOTAL_INVENTORY_LABEL; i++, x+=kg7Label.getWidth())
			totalInventoryLabel.get(i).setBounds(kg6Label.getX() + kg6Label.getWidth() + x - 2,
			productTotalLabel.getY(),
		...
		formsOverall.get(0).setBounds(overallSalesLabel.getX() + overallSalesLabel.getWidth(),
				overallSalesLabel.getY(), salesPane.getWidth() - overallSalesLabel.getWidth(), 15);
		...
		formsOverall.get(1).setBounds(overallDelLabel.getX() + overallDelLabel.getWidth(),
				overallDelLabel.getY(), delPane.getWidth() - overallDelLabel.getWidth(), 15);
		...
		overallARLabel.setBounds(
				...
				15);
		formsOverall.get(2).setBounds(overallARLabel.getX() + overallARLabel.getWidth(),
				overallARLabel.getY(), arPane.getWidth() - overallARLabel.getWidth(), 15);
		...
		formsOverall.get(3).setBounds(overallARPaymentLabel.getX() + overallARPaymentLabel.getWidth(),
				overallARPaymentLabel.getY(), arPaymentPane.getWidth() - overallARPaymentLabel.getWidth(), 15);
		...
		formsOverall.get(4).setBounds(overallCAPaymentLabel.getX() + overallCAPaymentLabel.getWidth(),
				overallCAPaymentLabel.getY(), caPaymentPane.getWidth() - overallCAPaymentLabel.getWidth(), 15);
		...
		formsOverall.get(5).setBounds(overallPulloutLabel.getX() + overallPulloutLabel.getWidth(),
				overallPulloutLabel.getY(), pulloutPane.getWidth() - overallPulloutLabel.getWidth(), 15);
		...
		formsOverall.get(6).setBounds(overallExpensesLabel.getX() + overallExpensesLabel.getWidth(),
				overallExpensesLabel.getY(), expensesPane.getWidth() - overallExpensesLabel.getWidth(), 15);
		...
		formsOverall.get(7).setBounds(overallCALabel.getX() + overallCALabel.getWidth(),
				overallCALabel.getY(), CAPane.getWidth() - overallCALabel.getWidth(), 15);
		...
		formsOverall.get(8).setBounds(overallDiscountLabel.getX() + overallDiscountLabel.getWidth(),
				overallDiscountLabel.getY(), discountPane.getWidth() - overallDiscountLabel.getWidth(), 15);
		...
		formsOverall.get(9).setBounds(overallAR2Label.getX() + overallAR2Label.getWidth(),
				overallAR2Label.getY(), ar2Pane.getWidth() - overallAR2Label.getWidth(), 15);
		...
		formsOverall.get(10).setBounds(overallSalaryLabel.getX() + overallSalaryLabel.getWidth(),
				overallSalaryLabel.getY(), salaryPane.getWidth() - overallSalaryLabel.getWidth(), 15);
		...
		formsOverall.get(11).setBounds(overallDepositLabel.getX() + overallDepositLabel.getWidth(),
				overallDepositLabel.getY(), depositPane.getWidth() - overallDepositLabel.getWidth(), 15);
		...
		cashBreakdownPanel.setBounds(computationLabel.get(0).getX()
				+ computationLabel.get(0).getWidth() + TABLE_GAP + TAB + TAB + 50,
				sectionLabel.get(3).getY() + sectionLabel.get(3).getHeight()
						+ LABEL_GAP, 340, 210);
		...
		sectionLabel.get(5).setBounds(
				startX,
				cohLabel.getY() + cohLabel.getHeight()
						+ SECTION_GAP, 150, 20);

		summary1Label.setBounds(startX + TAB, sectionLabel.get(5).getY()
				+ sectionLabel.get(5).getHeight() + LABEL_GAP, 200, 25);
		summary2Label.setBounds(summary1Label.getX() + summary1Label.getWidth(), summary1Label.getY()
				, 200, 25);
		summary3Label.setBounds(summary2Label.getX() + summary2Label.getWidth(), summary1Label.getY()
				, 201, 25);
		
		for(int i = 0, x = 0; i < 3; i++, x+=summary1Label.getWidth())
			summaryValues.get(i).setBounds(summary1Label.getX() + x, summary1Label.getY()
				+ summary1Label.getHeight(), 201, 30);
